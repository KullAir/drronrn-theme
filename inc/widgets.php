...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'drronen' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'drronen' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Left Sidebar', 'drronen' ),
				'id'            => 'left-sidebar',
				'description'   => __( 'Left sidebar widget area', 'drronen' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Slider', 'drronen' ),
				'id'            => 'hero',
				'description'   => __( 'Hero slider area. Place two or more widgets here and they will slide!', 'drronen' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Canvas', 'drronen' ),
				'id'            => 'herocanvas',
				'description'   => __( 'Full size canvas hero area for Bootstrap and other custom HTML markup', 'drronen' ),
				'before_widget' => '',
				'after_widget'  => '',
				'before_title'  => '',
				'after_title'   => '',
		...
		register_sidebar(
			array(
				'name'          => __( 'Top Full', 'drronen' ),
				'id'            => 'statichero',
				'description'   => __( 'Full top widget with dynamic grid', 'drronen' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Full', 'drronen' ),
				'id'            => 'footerfull',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'drronen' ),
				'before_widget' => '<div id="%1$s" class="footer-widget %2$s col-lg-6">',
