	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'drronen' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'drronen' ); ?></th>
			</tr>
		</thead>
		<tbody>
